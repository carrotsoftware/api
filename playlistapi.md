...
1. В ответ вы получите следующие сообщения-уведомления вида:
    ...
    - `EventId` - идентификатор элемента, который был сгруппирован. Тип `Guid`. Необходим для [обновления содержимого элемента](#Получение-содержимого-элемента).
...
1. В ответ вы получите следующие сообщения-уведомления вида:
    ...
    - `EventId` - идентификатор элемента, который был разгруппирован. Тип `Guid`. Необходим для [обновления содержимого элемента](#Получение-содержимого-элемента).
...
1. В ответ вы получите следующие сообщения-уведомления вида:
    ...
    - `EventId` - идентификатор элемента, который был изменен. Тип `Guid`. Необходим для [обновления содержимого элемента](#Получение-содержимого-элемента).
    - `Status` - статус элемента. Тип `Int`. Необходим для отображения состояния элемента и шаблона (Unloaded = 0, Loading = 1, Ready = 2, Active = 3).
